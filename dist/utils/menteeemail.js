...
exports.resetPassword = exports.menteeemail = void 0;
...
const menteeemail = (sender) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const mailerOption = {
            ...
            to: receiverEmail,
            subject: "Need a Research Mentee",
            html: `<!doctype html>
    <html>
      <head>
        <meta charset="utf-8">
     <title>Need a Research Mentee</title>
      </head>
      <body>
  
        <h3>From ${sender === null || sender === void 0 ? void 0 : sender.name}</h3>
        <br>
		  <h4>Department : ${sender === null || sender === void 0 ? void 0 : sender.faculty}</h4>
        <h4>phoneNumber : ${sender === null || sender === void 0 ? void 0 : sender.phoneNumber}</h4>
        <h4>ResearchTopic : ${sender === null || sender === void 0 ? void 0 : sender.ResearchArea}</h5>
		<br/>
		<br/>
		<br/>
		<br/>
...
exports.menteeemail = menteeemail;
